  ...
  "inline-flex items-center justify-center whitespace-nowrap text-[14px] desktop-s:text-p-l font-medium transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        linkHoverBlue:
          "py-[26px] tablet-xl:py-[21px] desktop-s:py-7 text-p-s desktop-s:text-p-l w-full px-16 rounded-[50px] h-[50px] font-medium bg-buttons-bg text-buttons-text flex items-center justify-center overflow-hidden transition-all before:absolute before:h-0 before:w-0 before:rounded-full before:bg-secondary-buttons-bg before:duration-700 duration-700 before:ease-out hover:bg-secondary-buttons-bg hover:text-black-heading-color hover:before:h-56 hover:before:w-56 ",
        linkHoverGreen:
          "py-[26px] tablet-xl:py-[21px] desktop-s:py-7 text-p-s desktop-s:text-p-l w-full px-16 rounded-[50px] h-[50px] font-medium bg-secondary-buttons-bg text-black-body-color flex items-center justify-center overflow-hidden transition-all before:absolute before:h-0 before:w-0 before:rounded-full before:bg-buttons-bg before:duration-700 duration-700 before:ease-out hover:bg-buttons-bg hover:text-white-body-color hover:before:h-56 hover:before:w-56 ",
