  ...
  return (
    <header
      className={`sticky top-0 z-10 flex items-center h-24 ${
        headerColor
          ? "bg-[#F8F8FC] shadow-sm transition duration-300"
    ...
    >
      <div className="wrapper w-full flex justify-between items-center bg-transparent">
        ...
        <div className="hidden desktop-s:flex items-center">
          <DesktopMenu />
          <button
            className={`h-[50px] relative px-10 rounded-[50px] font-medium bg-buttons-bg border-buttons-bg text-white-body-color flex items-center justify-center overflow-hidden transition-all before:absolute before:h-0 before:w-0 before:rounded-full before:bg-secondary-buttons-bg before:duration-500 before:ease-out hover:bg-secondary-buttons-bg  hover:text-black-heading-color hover:before:h-56 hover:before:w-56`}
          >
