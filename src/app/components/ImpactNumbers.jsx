...
export default function ImpactNumbers() {
  return (
    <div className="bg-[#6b86fa] desktop-s:h-[400px] desktop-l:h-[550px] desktop-l:pt-24 py-14 mobile-l:py-20 px-5 mobile-l:px-7 flex flex-col gap-7 items-center text-center">
      <h2 className="text-h2-s tablet-s:text-h2-l desktop-l:text-h2-xl desktop-l:mb-7 font-bold text-[#16171D]/70 tracking-tight">
