              ...
              <li key={link.key} className="m-auto">
                {link.subnav.length === 0 && (
                  <Link href={link.link} className="group relative">
                    <span>{link.name}</span>
                    <span className="w-full h-[10px] absolute bottom-0 left-0 translate-y-2 duration-500 ease-in-out opacity-0 bg-[#8f1472]/20 group-hover:-translate-y-[0.01rem] group-hover:opacity-100"></span>
                  </Link>
                )}
